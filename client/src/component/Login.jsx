    ...
    items-center '>
      ...
      className='relative bg-white p-10 rounded-xl text-state-500' >
       ...
       {state!=='Login'  &&  <div className='border px-6 py-2 flex items-center
        ...
        <p className='text-sm text-blue-500 my-4
        ...
        {state==='Login'? <p className='mt-5 text-center'>Dont's have account?<span className='text-blue-600 cursor-pointer' onClick={()=>setState('Sign Up')}>Sign Up</span></p>
        : <p className='mt-5 text-center'>Already have account?<span className='text-blue-600 cursor-pointer' onClick={()=>setState('Login')}>Login</span>
        </p>}
